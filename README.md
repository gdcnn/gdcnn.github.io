...
Сайт сделан с помощью [CMS Hugo](https://gohugo.io/) и является статическим, то есть на момент деплоя все странички уже скомпилированы и подложены в виде `.html` файлов.
